    ...
    return (
        ...
        >
            ...
            < div className="relative z-20" >
                <AnimatePresence>
                    {showUserMenu && (
                        <motion.div
                            ...
                            className="absolute bottom-full left-0 mb-4 w-72 bg-card border border-border/60 rounded-xl shadow-2xl overflow-hidden glass-panel"
                        >
                            {/* Header */}
                ...
                >
                    <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-primary to-blue-600 flex items-center justify-center text-xs font-bold text-white ring-2 ring-background">
                        XZ
                    </div>
